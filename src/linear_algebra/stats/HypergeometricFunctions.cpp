...
REGISTER_FUNCTION(hygepmf, UILIST(TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_DOUBLE), TypeId(TID_DOUBLE), stats_hygepmf);
REGISTER_FUNCTION(hygecdf, UILIST(TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_DOUBLE), TypeId(TID_DOUBLE), stats_hygecdf_default);
REGISTER_FUNCTION(hygecdf, UILIST(TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_BOOL), TypeId(TID_DOUBLE), stats_hygecdf_override);
REGISTER_FUNCTION(hygequant, UILIST(TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_BOOL), TypeId(TID_DOUBLE), stats_hygequant);
}  // namespace scidb
