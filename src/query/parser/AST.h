...
class Node
{
 ...
 protected:                // Construction
            ...
            void*             operator new  (size_t, arena::Arena&, cnodes);
            void              operator delete(void*, arena::Arena&, cnodes) {}
...
class Factory
{
 ...
 public:                   // Node Construction
            arena::Arena&     getArena()           const {return _arena;}
 ...
 public:                   // Node Construction
            ...
            Node*             newNode   (type,const location&,Node*,cnodes);
 ...
 public:                   // Constant Construction
            ...
            Node*             newString (const location&,chars); // BEWARE: No strdup, chars must live in _arena
            Node*             newString (const location&,std::string const&); // Safely calls _arena.strdup()
 ...
 private:                  // Representation
            arena::Arena&      _arena;                    // Memory allocator
...
Table*                        newTable (arena::Arena&, Log&, Table*, cnodes bindings);
