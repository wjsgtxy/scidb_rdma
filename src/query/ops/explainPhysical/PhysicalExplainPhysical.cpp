...
static log4cxx::LoggerPtr logger(log4cxx::Logger::getLogger("scidb.ops._explainPhysical"));
...
public:
    ...
    void preSingleExecute(std::shared_ptr<Query> query)
    {
...

        {
            ...
            LOG4CXX_INFO(logger, "@@@PhysicalExplainPhysical::preSingleExecute(): "  << planString.str());
        }
