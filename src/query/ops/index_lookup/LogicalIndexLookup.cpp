...
public:
    ...
    static PlistSpec const* makePlistSpec()
    {
        static PlistSpec argSpec {
            ...
            {IndexLookupSettings::KW_IDX_SORTED, RE(PP(PLACEHOLDER_CONSTANT, TID_BOOL))},
            {IndexLookupSettings::KW_MEM_LIMIT, RE(PP(PLACEHOLDER_CONSTANT, TID_INT64))}
        };
        return &argSpec;
    }
    ...
    ArrayDesc inferSchema(vector< ArrayDesc> schemas, std::shared_ptr< Query> query)
    {
        ...
        AttributeDesc newAttribute(settings.getOutputAttributeName(),
                                   TID_INT64,
        ...
        return result.addEmptyTagAttribute();
    }
};
