...
void subarrayMappingArray(std::string const& dimName,
                          std::string const& mappingArrayName,
                          std::string const& tmpMappingArrayName,
                          Coordinate from,
                          Coordinate till,
...
protected:
  ...
  public:
	 ...
	 */
	SubArrayIterator(SubArray const& subarray, const AttributeDesc& attrID, bool doRestart = true);
...
public:
    MappedSubArrayIterator(SubArray const& subarray, const AttributeDesc& attrID);
