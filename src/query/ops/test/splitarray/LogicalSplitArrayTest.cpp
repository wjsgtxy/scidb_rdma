...
public:
    ...
    ArrayDesc inferSchema(std::vector< ArrayDesc> schemas, std::shared_ptr< Query> query)
    {
        ...
        if(schema.getAttributes().firstDataAttribute().getType() != TID_DOUBLE)
            throw SYSTEM_EXCEPTION(SCIDB_SE_INTERNAL, SCIDB_LE_ILLEGAL_OPERATION)
        ...
        Attributes outAtts;
        AttributeDesc resultAttr("v",  TID_DOUBLE, 0, CompressorType::NONE);
        ...
        return ArrayDesc("Splitarraytest", outAtts.addEmptyTagAttribute(), outDims,
