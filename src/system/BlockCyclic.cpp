...
InstanceID
ScaLAPACKArrayDistribution::DistTypeDataForScaLAPACK::getInstanceID(const Coordinates& chunkPos,
                                                                              const ProcGrid* const procGrid ) const
{
    ...
    LOG4CXX_TRACE(logger, "DistTypeDataScaLAPACK::getInstanceID(chunkPos=("
...
ScaLAPACKArrayDistribution::ScaLAPACKArrayDistribution(size_t redundancy,
  ...
  : ArrayDistribution(dtScaLAPACK, redundancy) {
    ...
    _repartInfo.reset(new DistTypeDataForScaLAPACK(blacsGridSize, blacsBlockSize));
}


std::string
ScaLAPACKArrayDistribution::getState() const
{
