...
public:
    ...
    public:
        ArrayIterator(OpArray const& delgate, const AttributeDesc& attrID);
...
public:
    ...
    ArrayIterator*      createArrayIterator(const AttributeDesc& id) const override;
    private:
    Op_tt               _op;
...
template<class Op_tt>
typename OpArray<Op_tt>::ArrayIterator* OpArray<Op_tt>::createArrayIterator(const AttributeDesc& _id) const
{
    return new ArrayIterator(*this, _id);
}
