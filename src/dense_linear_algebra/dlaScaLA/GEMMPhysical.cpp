                                          ...
                                          ArrayDesc& outSchema)
{
    ...
    //
    slpp::context_t blacsContext = doBlacsInit(inputArrays, query, "GEMMPhysical");
    ...
    // 1. redistribute to dtScaLAPACK (when not already correct).
    ...
    //
    // redistribute to dtScaLAPACK, and convert to ScaLAPACK format.
    // NOTE: this redistribution must be kept in sync with the particpatingInMPI redistributeInputArrays, above
