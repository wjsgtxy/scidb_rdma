...
REGISTER_FUNCTION(fact, UILIST("int64"), "string", constructfact);
REGISTER_FUNCTION(mylog, UILIST("double", "double"), "double", constructmylog);
REGISTER_FUNCTION(lasso, UILIST("double", "double", "double"), "double", jameslasso);
REGISTER_FUNCTION(isprime, UILIST("int64"), "string", checkisprime);
