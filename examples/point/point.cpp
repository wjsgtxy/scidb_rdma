...
public:
    ...
    PointLibrary()
    {
        ...
        _functionDescs.push_back(FunctionDescription("point", {}, TypeId("point"), &construct_point));
        _functionDescs.push_back(FunctionDescription("str2point", {TID_STRING}, TypeId("point"), &str2Point));
        _functionDescs.push_back(FunctionDescription("point2str", {"point"}, TID_STRING, &point2Str));
        _functionDescs.push_back(FunctionDescription("+",  {"point", "point"}, TypeId("point"), &sumPoints));
