...
public:
    ...
    {
        /*
         * Make one string attribute: name="instance_status" of type string, no flags, no default compression.
         ...
         */
        AttributeDesc outputAttribute ("instance_status", TID_STRING,
                                       0, CompressorType::NONE);
        Attributes outputAttributes;
        outputAttributes.push_back(outputAttribute);
        ...
        return ArrayDesc("hello_instances", outputAttributes.addEmptyTagAttribute(), outputDimensions,
