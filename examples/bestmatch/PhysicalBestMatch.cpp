...
REGISTER_FUNCTION(radec2x, UILIST(TID_DOUBLE, TID_DOUBLE), TID_DOUBLE, radec2x);
REGISTER_FUNCTION(radec2y, UILIST(TID_DOUBLE, TID_DOUBLE), TID_DOUBLE, radec2y);
REGISTER_FUNCTION(radec2z, UILIST(TID_DOUBLE, TID_DOUBLE), TID_DOUBLE, radec2z);
REGISTER_FUNCTION(radec_sindist, UILIST(TID_DOUBLE, TID_DOUBLE, TID_DOUBLE, TID_DOUBLE), TID_DOUBLE, radec_sindist);
