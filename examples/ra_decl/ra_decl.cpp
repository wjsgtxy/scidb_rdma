...
REGISTER_SUBTYPE(right_ascension, 8, TID_DOUBLE);
...
REGISTER_FUNCTION(ordinal, UILIST("right_ascension"), TID_INT64, RAToOrdinal);
REGISTER_FUNCTION(right_ascension, UILIST(TID_INT64), "right_ascension", RAFromOrdinal);
REGISTER_FUNCTION(ordinal, UILIST("declination"), TID_INT64, DECLToOrdinal);
REGISTER_FUNCTION(declination, UILIST(TID_INT64), "declination", DECLFromOrdinal);

//
// Need casts to double().
//
REGISTER_FUNCTION(double, UILIST("right_ascension"), TID_DOUBLE, RAToDouble);
REGISTER_FUNCTION(double, UILIST("declination"), TID_DOUBLE, DECLToDouble);
