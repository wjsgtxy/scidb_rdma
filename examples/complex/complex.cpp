...
REGISTER_FUNCTION(+, UILIST("complex", "complex"), "complex", addComplex);
REGISTER_FUNCTION(-, UILIST("complex", "complex"), "complex", subComplex);
REGISTER_FUNCTION(*, UILIST("complex", "complex"), "complex", mulComplex);
REGISTER_FUNCTION(/, UILIST("complex", "complex"), "complex", divComplex);
REGISTER_FUNCTION(=, UILIST("complex", "complex"), "bool", eqComplex);
REGISTER_FUNCTION(<>,UILIST("complex", "complex"), "bool", neComplex);

REGISTER_FUNCTION(re, UILIST("complex"), "double", reComplex);
REGISTER_FUNCTION(im, UILIST("complex"), "double", imComplex);
...
public:
    ComplexLibrary()
    {
        ...
        _functionDescs.push_back(FunctionDescription("complex", {}, TypeId("complex"), &constructDefaultComplex));
        _functionDescs.push_back(FunctionDescription("complex",
                                                     {"double", "double"},
                                                     TypeId("complex"),
                                                     &constructComplex));
